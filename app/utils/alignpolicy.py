...
class Candidate(BaseModel):
    ...
    manifestos:List[str]=Field(description="which policy statements align with the your policy choices. The order of the policies in the manifesto align with your policy choices.")
